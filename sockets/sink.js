/**
 *
 * Single connection script to clean up transport socket when it is overwhelmed with responses so that it does not keep retrying and just delivers
 * messages without new messages being emitted
 *
 */
...
const messagesPerSecond = 300; // Number of messages to send per second
